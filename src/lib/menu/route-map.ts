...
const ROUTE_ALIASES: Record<string, string> = {
  ...
  "/holiday/yearly-working-calander": "/holiday/yearly-working-calander",
  "/holiday/yearly-working-calendar": "/holiday/yearly-working-calander",
  "/organization/yearly-working-calendar": "/holiday/yearly-working-calander",
  ...
  "/leave/leave-entitlement": "/leave/leave-entitlement",
  "/leave/entitlement": "/leave/leave-entitlement",
  "/leave/leave-requisition": "/leave/leave-requisition",
  "/leave/requisition": "/leave/leave-requisition",
  ...
  "/reports/leave-employee": "/reports/leave/employee",
  "/reports/employee-wise-leave": "/reports/leave/employee",
  ...
  "/settings/sms-config": "/settings/sms",
  "/settings/sms-configuration": "/settings/sms",
  "/settings/document": "/settings/document",
  "/settings/document-settings": "/settings/document",
  "/settings/documents": "/settings/document",
  "/settings/attendance": "/settings/attendance",
  "/settings/attendance-settings": "/settings/attendance",
  "/settings/attendance-rules": "/settings/attendance",
  "/settings/leave": "/settings/leave",
  "/settings/leave-settings": "/settings/leave",
  "/settings/leave-rules": "/settings/leave",
  "/settings/payroll": "/settings/payroll",
  "/settings/payroll-settings": "/settings/payroll",
  "/settings/salary-settings": "/settings/payroll",
  "/settings/tax": "/settings/tax",
  "/settings/tax-settings": "/settings/tax",
  "/settings/tds": "/settings/tax",
  "/settings/professional-tax": "/settings/tax",
...
const LABEL_ROUTES: Array<{ match: RegExp; href: string }> = [
  ...
  { match: /^yearly\s*working\s*calen[ae]r$/i, href: "/holiday/yearly-working-calander" },
  ...
  { match: /^leave\s*entitlement$/i, href: "/leave/leave-entitlement" },
  { match: /^leave\s*requisition$/i, href: "/leave/leave-requisition" },
  ...
  { match: /^sms\s*(configuration|config|settings|gateway|templates?)?$/i, href: "/settings/sms" },
  { match: /^document\s*settings?$/i, href: "/settings/document" },
  { match: /^attendance\s*settings?$/i, href: "/settings/attendance" },
  { match: /^leave\s*settings?$/i, href: "/settings/leave" },
  { match: /^payroll\s*settings?$/i, href: "/settings/payroll" },
  { match: /^salary\s*settings?$/i, href: "/settings/payroll" },
  { match: /^tax\s*settings?$/i, href: "/settings/tax" },
  { match: /^(professional\s*tax|tds)(\s*settings?)?$/i, href: "/settings/tax" },
