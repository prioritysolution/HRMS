...
import { MOCK_EMPLOYEES, MOCK_EMPLOYEE_LEAVE } from "@/data/reports-mock";
...
export const MASTER_DATA_API_SERVICES: Record<string, MasterDataApiService> = {
  ...
  "employee-attendance-report": {
    list: (params) => employeeAttendanceReportService.list(params),
    create: async (row) => row,
    update: async (_id, row) => row,
    remove: async () => ({}),
  },
  "late-coming-report": {
    list: (params) => lateComingReportService.list(params),
    create: async (row) => row,
    update: async (_id, row) => row,
    remove: async () => ({}),
  },
  ...
  "leave-register-report": {
    list: (params) => leaveRegisterReportService.list(params),
    create: async (row) => row,
    update: async (_id, row) => row,
    remove: async () => ({}),
  },
